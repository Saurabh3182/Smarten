...
public class ExtentListenerClass implements ITestListener
{
	...
	//	htmlReporter = new ExtentSparkReporter(System.getProperty("user.dir") + "/Reports/" + reportName);
		htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+"/test-output/ExtendReport/testdome-Test "+timestamp+".html");
	...
	{		
		...
		String screenShotPath = System.getProperty( "D:\\TestingSetUP\\EclipseWorkPlace\\testdome\\test-output\\ScreenShot\\." + Result.getName() + ".png");
